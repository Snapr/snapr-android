...
public class FacebookPublishAsyncTask extends AbstractErrorHandlingAsyncTask<FacebookPublishInfo, Void, Void>
{
	...
	protected Void computeResult(FacebookPublishInfo... params) throws HttpPosterException, JSONException
	{
		...
		Vector<BasicNameValuePair> parameters = getFacebookPublishParams(publishInfo.mToken, publishInfo.mSnaprToken, publishInfo.mTokenExpirationDate, publishInfo.mTokenPermissions);
		
		// Post to endpoint and get result
		HttpPoster poster = new HttpPoster();
		String jsonString = poster.post(Global.URL_FACEBOOK_PUBLISH, parameters);
